...
const form = useForm({
    ...
    age_unit: props.patient.age_unit ?? 'years',
...
const submit = () => {
    form.put(route('patients.update', props.patient.ulid));
};
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                <Link :href="route('patients.show', patient.ulid)" class="text-gray-500 hover:text-gray-700">
